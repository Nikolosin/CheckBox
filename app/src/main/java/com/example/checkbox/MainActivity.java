...
public class MainActivity extends AppCompatActivity {
    ...
    public   void onClickOk(View v){
        ...
        String infoVal = mInputInfo.getText().toString();
        String info = null;
        switch (mInputInfo.getInputType()) {
            case InputType.TYPE_CLASS_NUMBER: info = getString(R.string.bankCardChkBx); break;

            case InputType.TYPE_CLASS_PHONE: info = getString(R.string.mobilePhoneChkBx); break;

            case InputType.TYPE_CLASS_TEXT: info = getString(R.string.cashAddressChkBx); break;
        }

        String msg = money + " руб отправлено " + info + " " + infoVal;
        if (mInputInfo.getText().toString().equals("")){
